<header class="container">
    <div class="row">
        <div class="col-sm-12 col-xs-12 col-lg-6 col-lg-offset-3">
            ...
            <h1 class="titre text-center visible-xs visible-md visible-sm">
...
<div class="container">
    <!-- SnapWidget visible pour tous les supports sauf les xs -->
...
<!-- widget visible uniquement sur potable -->
<div class="container">
    <!-- SnapWidget -->
        <div class="col-xs-4 col-xs-offset-1 hidden-sm hidden-md hidden-lg">
            <hr>
            <iframe src="https://snapwidget.com/embed/456871" class="snapwidget-widget" allowTransparency="true" scrolling="no"
            style="border:none; overflow:hidden; width:250px; height:300px"></iframe>
            <hr>
        </div>
</div>
